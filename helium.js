var zeppelinHeliumPackages = [{"zeppelin-echo-spell": {
    "1.0.4": {
      "type": "SPELL",
      ...
      "spell": {"magic": "%echo", "usage": "%echo <TEXT>"}
    },
    "1.0.5": {
      "type": "SPELL",
      "name": "zeppelin-echo-spell",
      "version": "1.0.5",
      "published": "2017-03-05T03:37:00.185Z",
      "artifact": "zeppelin-echo-spell@1.0.5",
      "author": "1ambda",
      "description": "Zeppelin Echo Spell (example)",
      "license": "Apache-2.0",
      "icon": "<i class='fa fa-repeat'></i>",
    ...
    "latest": {
      ...
      "name": "zeppelin-echo-spell",
      "version": "1.0.6",
      "published": "2017-03-07T11:37:44.283Z",
      "artifact": "zeppelin-echo-spell@1.0.6",
      "author": "1ambda",
      "description": "Zeppelin Echo Spell (example)",
      "license": "Apache-2.0",
      "icon": "<i class='fa fa-repeat'></i>",
...
"zeppelin-flowchart-spell": {
    "0.0.1": {
      ...
      "spell": {"magic": "%flowchart", "usage": "%flowchart <TEXT>"}
    },
    "latest": {
      "type": "SPELL",
      "name": "zeppelin-flowchart-spell",
